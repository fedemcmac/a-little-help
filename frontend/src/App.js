...
class App extends Component {
  ...
  availableJobs = () => {
    ...
    // return this.state.jobs.filter(job => {///////////////////////////////////////////////////////
    //   return job.owner.id !== this.state.user.id}).filter(notUserJob => {
    //   return !this.state.user.helping_jobs_ids.includes(notUserJob.id)
    //   })
  };
