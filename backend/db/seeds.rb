...
u1 = User.create(username: 'Bick', email: "bick@bick.com", password: "Bick")
u2 = User.create(username: 'Jox', email: "jox@jox.com", password: "jox")
u3 = User.create(username: 'Jowita', email: "jowita@jowita.com", password: "jowita")
...
j6 = Job.create(title: "Look after Toshi the majestic ginger cat", summary: "Cat sitting", category: "Animals", description: "I am visiting my family abroad and I need someone who likes  cats to look after my little Tishi Toshi. He likes ear rubs, a clean litter and tons of food. Please let me know if you would like to enjoy Toshi's company :3", user_id: u3.id, address: "Newington Green, London, UK" ,lat: 51.5514507, lng: -0.08575350000000981)
